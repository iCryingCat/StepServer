...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        public static LJsonData ToObject(JsonReader reader)
        {
            return (LJsonData)ToWrapper(
                delegate { return new LJsonData(); }, reader);
        }

        public static LJsonData ToObject(TextReader reader)
        {
            JsonReader json_reader = new JsonReader(reader);

            return (LJsonData)ToWrapper(
                delegate { return new LJsonData(); }, json_reader);
        }

        public static LJsonData ToObject(string json)
        {
            return (LJsonData)ToWrapper(
                delegate { return new LJsonData(); }, json);
        }
